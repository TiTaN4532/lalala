...
/**
 * @ORM\Entity(repositoryClass="LaNet\LaNetBundle\Entity\Repository\ShopRepository")
 * @ORM\Table(name="shop_info")
 * @ORM\HasLifecycleCallbacks()
 */
class Shop extends \LaNet\LaNetBundle\Model\UploadImages
{
      /**
     * @ORM\Id
